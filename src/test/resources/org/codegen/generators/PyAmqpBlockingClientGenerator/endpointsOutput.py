...
class Generated:
    ...
    def get_container_dto(self, filter_by: FilterBy | None = None) -> ContainerDto:
        """
        endpoint with optional enum filter
        """
        args = (filter_by,)
        raw_data = self._client.mk_request(f'/api/v1/container', 'get_container_dto', *args).get()
