...
```shell
wget -qO- https://github.com/atten/ez-code-generator/releases/download/v4.1.3/ez-codegen-4.1.3.zip | busybox unzip -
cd ez-codegen-4.1.3/bin/
chmod +x ez-codegen
```
...
```shell
pip install ez-code-generator==4.1.3
```
