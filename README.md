...
```shell
wget -qO- https://github.com/atten/ez-code-generator/releases/download/v5.0.0/ez-codegen-5.0.0.zip | busybox unzip -
cd ez-codegen-5.0.0/bin/
chmod +x ez-codegen
```
...
```shell
pip install ez-code-generator==5.0.0
```
